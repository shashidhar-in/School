...
import com.example.school.databinding.FragmentTDashboardBinding;
 ...
 */
public class T_DashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.nav_host_fragment_content_main_teacher, chatFragment);
                transaction.commit();
